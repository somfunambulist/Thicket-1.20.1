...
import net.somfunambulist.thicket.entity.custom.ModChestBoatEntity;
...
public class ModBoatRenderer<T extends ModBoatEntity> extends EntityRenderer<T> {
    ...
    public ModBoatRenderer(EntityRendererProvider.Context context, boolean hasChest) {
        ...
        this.boatResources = Stream.of(ModBoatEntity.Type.values()).collect(ImmutableMap.toImmutableMap(type -> type,
                type -> Pair.of(type.getTexture(hasChest), this.createBoatModel(context, type, hasChest))));
        ;
    }
    ...
    private ListModel<Boat> createBoatModel(EntityRendererProvider.Context context, ModBoatEntity.Type type, boolean hasChest) {
        ModelLayerLocation modelLayerLocation = hasChest ?
                new ModelLayerLocation(new ResourceLocation(Thicket.MOD_ID, type.getChestModelLocation()), "main")
                : new ModelLayerLocation(new ResourceLocation(Thicket.MOD_ID, type.getModelLocation()), "main");
